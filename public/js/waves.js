...
class AWaves extends HTMLElement {
    ...
    //Mouse handler
    onMouseMove(e) {
        // this.updateMousePosition(e.pageX, e.pageY)               ---> uncomment for mouse interaction
    } 
    // Touch handler
    onTouchMove(e) {
        e.preventDefault()   
        const touch = e.touches[0]
        // this.updateMousePosition(touch.clientX, touch.clientY)   ---> uncomment for mouse interaction
    }  
